...
<head>
  ...
  * Author Website: https://aboutmdshojeb.blogspot.com
  * Author: MD SHOJEB
  ======================================================== -->
</head>
...
<body id="page-top">
  ...
  @section('page-intro')
  <div class="intro intro-single route bg-image" style="background-image: url({{asset('frontend/assets/img/overlay-bg.jpg')}})">
